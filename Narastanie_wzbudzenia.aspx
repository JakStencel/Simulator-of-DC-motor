<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Narastanie_wzbudzenia.aspx.cs" Inherits="Narastanie_wzbudzenia" %>
    ...
    <form id="form2" runat="server">
            ...
            <ul class="sidebar-nav">
                ...
                <li id="rozwijane">
                    ...
                    <ul id="rozwijane_menu">
                        <li style="margin-left:-75px;padding-left:0px;"><a href="#"><img src="img/001-presentation.png" /> Narastanie prądu I<sub>f</sub></a></li>
                        <li><a href="Bieg_jalowy.aspx"><img src="img/002-presentation.png" /> Bieg jałowy</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                         <h2 style="color:darkgrey; margin-left:auto; margin-right:auto; text-align:center;">Symulacja narastania prądu wzbudzenia silnika ARBZc132SZ</h2>
                        <br />
                    ...
                    <asp:Chart ID="Chart1" runat="server"  Height="300px" 
                        ...
                        <Titles>
                            <asp:Title Font="Segoe UI, 18pt, style=Bold" Text="Narastanie prądu wzbudzenia"></asp:Title>
                        </Titles>
                        <Series>
