<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Bieg_jalowy.aspx.cs" Inherits="Bieg_jalowy" %>
    ...
    <form id="form1" runat="server">
            ...
            <ul class="sidebar-nav">
                ...
                <li id="rozwijane">
                    ...
                    <ul id="rozwijane_menu">
                        <li style="margin-left:-120px;padding-left:0px;"><a href="#"><img src="img/001-presentation.png" /> Bieg jałowy</a></li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                         <h2 style="color:darkgrey; margin-left:auto; margin-right:auto; text-align:center;">Symulator biegu jałowego silnika ARBZc132SZ</h2>
                         <br />
                            <asp:Image ID="imgBiegJalowy" runat="server" AlternateText="schemat układu biegu jałowego" ImageUrl="img/schemat_chatyka_magnesowania.jpg" 
                                ImageAlign="Middle" HorizontalAlign="Center" Width="460px" Height="366px" 
                                style="margin-left:auto; margin-right:auto; text-align:center;"/>
                            <h6 style="margin-left:auto; margin-right:auto; text-align:center;">Schemat układu dla charakterystyki magnesowania</h6>
                            <br />
                            <asp:Panel ID="validation" runat="server"  Width="600px"
                                ...
                                <asp:Label ID="labErrorMessage_ω" runat="server" Text="[tu wiadomosc]" Font-Bold="true" ForeColor="Red" ></asp:Label>
                                </p><p>
...
<%--                                <table style=" border-color: black; width:100%;">
                                    <tr>
                                        <td style="width:50%; padding-top:10px;"> 
                                            <fieldset style="width: 100%;">                                  
                                                <legend align="center"><b>Parametry obwodu wzbudzenia</b></legend>
                                                <p>Zakres napięcia zasilającego U<sub>f</sub></p>
                                                <table style="border-color: black;">
                                                    <tr>
                                                        <td width="300px">Dolny zakres napięcia U<sub>f</sub></td>
                                                        <td width="50px"><asp:TextBox ID="txtUfmin" runat="server" Width="40px" Text="0"></asp:TextBox></td>
                                                        <td>[V]</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Górny zakres napięcia U<sub>f</sub></td>
                                                        <td><asp:TextBox ID="txtUfmax" runat="server" Width="40px" Text="3"></asp:TextBox></td>
                                                        <td>[V]</td>
                                                    </tr>
                                                </table>
                                            </fieldset>
                                        ...
                                        <td rowspan="2" style="padding-top:10px;">
                                            <fieldset style="width: 100%; height:100%;" >
                                                ...
                                                <table style="border-color: black; margin-left:auto; 
                                                    ...
                                                    <tr>
                                                        <td width="290px">Indukcyjność obwodu wzbudzenia I<sub>f</sub>
                                                        </td>
                                                        <td width="40px">
                                                            <asp:TextBox ID="txtMf_ext" runat="server" Width="40px" Text="0" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td width="20px"> [mH]
                                                        </td>
                                                    </tr>                                                               
                                                ...
                                                <table style="border-color: black;">
                                                    <tr>
                                                        <td width="300px">Prędkość kątowa wału silnika ω
                                                        </td>
                                                        <td width="40px">
                                                            <asp:TextBox ID="txtω" runat="server" Width="40px" Text="147" MaxLength="3"></asp:TextBox>
                                                        </td>
                                                        <td width="20px"> [rad/s]
                                                        </td>
                                                    </tr>
                               ...
                               <%-- <table style=" border-color: black; width:100%;">
                                    <tr>
                                        <td style="padding-top:10px;">
                                            <fieldset style="width: 100%;">
                                                <legend align="center"><b>Prędkość kątowa wału silnika</b></legend>
                                                <table style="border-color: black;">
                                                    <tr>
                                                        <td width="250px">Prędkość kątowa wału silnika ω
                                                        </td>
                                                        <td width="60px">
                                                            <asp:TextBox ID="txtω" runat="server" Width="40px" Text="230"></asp:TextBox>
                                                        </td>
                                                        <td>[rad/s]
                                                        </td>
                                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            <fieldset style="width: 90%">
                                                ...
                                                <table style=" border-color: black;">
                                                    <tr>
                                                        <td width="400px" rowspan="3"><asp:Image ID="imgMoment" runat="server" AlternateText="wykres momentu" ImageUrl="~/moment.png" ImageAlign="Middle" width="90%" /> </td>
                                                ...
                                                <fieldset style="width: 90%">
                                                    ...
                                                    <table style=" border-color: black;">
                                                        <tr>
                                                            ...
                                                            <td width="60px"><asp:TextBox ID="txtJr_ext" runat="server" Width="40px" Text="0"></asp:TextBox></td>
                                                            <td>[kg*m<sup>2</sup>]</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Współczynnik tłumienia D<sub>rext</sub></td>
                                                            <td><asp:TextBox ID="txtDr_ext" runat="server" Width="40px" Text="0"></asp:TextBox></td>
                                                            <td>[(Nm*s)/rad]</td>
                                                        </tr>
                                                    </table>
                                                </fieldset>
                    ...
                    <asp:Chart ID="Chart1" runat="server"  Height="300px" 
                        ...
                        <Titles>
                            <asp:Title Font="Segoe UI, 18pt, style=Bold" Text="Charakterystyka magnesowania"></asp:Title>
                        </Titles>
                        <Series>
